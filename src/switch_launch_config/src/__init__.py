...
"""
NODE_NAME = "switch_launch_config"
""" -------------------------------------------------------------------- """
...
if __name__ == '__main__':
    ...
    try:
        ...
        TO CHANGE DEPENDING ON THE PACKAGE:
        """
        from configSwitch import ConfigSwitch
        main = ConfigSwitch(rospy.get_param("~nodeToReconfigure", None), 
                            int(rospy.get_param("~delay", None)),
                            rospy.get_param("~launchFilePackage", None), 
                            rospy.get_param("~launchFile", None))
        """ ----------------------------------- """
