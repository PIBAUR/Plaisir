...
class LidarBliter
{
  ...
  public :
    LidarBliter()
   {
      map_ = cv::imread("/home/serveur/catkin_ws/maps/piece1.pgm",CV_LOAD_IMAGE_COLOR);
    ...
    void laserfilter(const sensor_msgs::LaserScan& laser)
    {
      laser_point_.clear();
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber sub = n.subscribe("base_scan2",1, &LidarBliter::laserCb, &lb);  
