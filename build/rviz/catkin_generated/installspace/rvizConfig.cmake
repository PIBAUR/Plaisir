...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/serveur/catkin_ws/src/rviz)
  set(rviz_DEVEL_PREFIX /home/serveur/catkin_ws/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/serveur/catkin_ws/install)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE;/usr/include" STREQUAL "")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/usr/include/OGRE;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/serveur/catkin_ws/install/${idir}'.  Ask the maintainer 'David Gossow <dgossow@gmail.com>, William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rviz_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rviz;default_plugin;OgreMain;pthread;/usr/lib/i386-linux-gnu/libGLU.so;/usr/lib/i386-linux-gnu/libGL.so;/usr/lib/i386-linux-gnu/libSM.so;/usr/lib/i386-linux-gnu/libICE.so;/usr/lib/i386-linux-gnu/libX11.so;/usr/lib/i386-linux-gnu/libXext.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rviz_dep}_FOUND)
      find_package(${rviz_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rviz_dep} REQUIRED ${depend_list})
  endif()
