...
static const char qt_meta_stringdata_rviz__ImageDisplay[] = {
    "rviz::ImageDisplay\0\0updateNormalizeOptions()\0"
};
...
const QMetaObjectExtraData rviz::ImageDisplay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::ImageDisplay::staticMetaObject = {
    { &ImageDisplayBase::staticMetaObject, qt_meta_stringdata_rviz__ImageDisplay,
      qt_meta_data_rviz__ImageDisplay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::ImageDisplay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ImageDisplay))
