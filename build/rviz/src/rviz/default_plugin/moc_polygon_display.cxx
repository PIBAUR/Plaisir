...
**
** Created: Mon Sep 8 12:05:35 2014
...
static const char qt_meta_stringdata_rviz__PolygonDisplay[] = {
    "rviz::PolygonDisplay\0"
};
...
const QMetaObjectExtraData rviz::PolygonDisplay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::PolygonDisplay::staticMetaObject = {
    { &MessageFilterDisplay<geometry_msgs::PolygonStamped>::staticMetaObject, qt_meta_stringdata_rviz__PolygonDisplay,
      qt_meta_data_rviz__PolygonDisplay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::PolygonDisplay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PolygonDisplay))
        return static_cast<void*>(const_cast< PolygonDisplay*>(this));
    typedef MessageFilterDisplay<geometry_msgs::PolygonStamped> QMocSuperClass;
