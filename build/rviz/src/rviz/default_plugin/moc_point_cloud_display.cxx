...
**
** Created: Mon Sep 8 12:05:34 2014
...
static const char qt_meta_stringdata_rviz__PointCloudDisplay[] = {
    "rviz::PointCloudDisplay\0\0updateQueueSize()\0"
};
...
const QMetaObjectExtraData rviz::PointCloudDisplay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::PointCloudDisplay::staticMetaObject = {
    { &MessageFilterDisplay<sensor_msgs::PointCloud>::staticMetaObject, qt_meta_stringdata_rviz__PointCloudDisplay,
      qt_meta_data_rviz__PointCloudDisplay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::PointCloudDisplay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PointCloudDisplay))
        return static_cast<void*>(const_cast< PointCloudDisplay*>(this));
    typedef MessageFilterDisplay<sensor_msgs::PointCloud> QMocSuperClass;
