...
static const char qt_meta_stringdata_rviz__InteractionTool[] = {
    "rviz::InteractionTool\0\0"
...
const QMetaObjectExtraData rviz::InteractionTool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::InteractionTool::staticMetaObject = {
    { &Tool::staticMetaObject, qt_meta_stringdata_rviz__InteractionTool,
      qt_meta_data_rviz__InteractionTool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::InteractionTool::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__InteractionTool))
