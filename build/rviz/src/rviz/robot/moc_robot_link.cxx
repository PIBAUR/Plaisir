...
static const char qt_meta_stringdata_rviz__RobotLink[] = {
    "rviz::RobotLink\0\0updateVisibility()\0"
...
const QMetaObjectExtraData rviz::RobotLink::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::RobotLink::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__RobotLink,
      qt_meta_data_rviz__RobotLink, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::RobotLink::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__RobotLink))
