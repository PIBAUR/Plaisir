...
**
** Created: Mon Sep 8 12:02:31 2014
...
static const char qt_meta_stringdata_rviz__PropertyTreeModel[] = {
    "rviz::PropertyTreeModel\0\0property\0"
    "propertyHiddenChanged(const Property*)\0"
    "configChanged()\0index\0expand(QModelIndex)\0"
    "collapse(QModelIndex)\0"
};
...
const QMetaObjectExtraData rviz::PropertyTreeModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::PropertyTreeModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_rviz__PropertyTreeModel,
      qt_meta_data_rviz__PropertyTreeModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::PropertyTreeModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PropertyTreeModel))
        return static_cast<void*>(const_cast< PropertyTreeModel*>(this));
