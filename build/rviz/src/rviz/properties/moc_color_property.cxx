...
**
** Created: Mon Sep 8 12:02:30 2014
...
static const char qt_meta_stringdata_rviz__ColorProperty[] = {
    "rviz::ColorProperty\0\0bool\0color\0"
    "setColor(QColor)\0"
};
...
const QMetaObjectExtraData rviz::ColorProperty::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::ColorProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__ColorProperty,
      qt_meta_data_rviz__ColorProperty, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::ColorProperty::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ColorProperty))
