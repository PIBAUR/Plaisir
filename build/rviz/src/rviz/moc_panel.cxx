...
static const char qt_meta_stringdata_rviz__Panel[] = {
    "rviz::Panel\0\0configChanged()\0"
};
...
const QMetaObjectExtraData rviz::Panel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::Panel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rviz__Panel,
      qt_meta_data_rviz__Panel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::Panel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__Panel))
