...
static const char qt_meta_stringdata_rviz__FrameManager[] = {
    "rviz::FrameManager\0\0fixedFrameChanged()\0"
};
...
const QMetaObjectExtraData rviz::FrameManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rviz::FrameManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__FrameManager,
      qt_meta_data_rviz__FrameManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rviz::FrameManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__FrameManager))
